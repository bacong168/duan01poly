...
public class AlbumDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(uri)
                ...
                .into(ivAlbumDetail);
//        ivAlbumDetail.getBackground().setAlpha();
        songAdapter = new SongAdapter(getApplicationContext(), songLoader.getAllSong(getApplicationContext(), MediaStore.Audio.Media.IS_MUSIC + "=1" + " and " + MediaStore.Audio.Media.ALBUM_ID + "=" + Long.parseLong(albumID)));//+" and "+ MediaStore.Audio.Media.ALBUM_ID + "=149"
