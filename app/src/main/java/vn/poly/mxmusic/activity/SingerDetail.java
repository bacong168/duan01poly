...
public class SingerDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songAdapter = new SongAdapter(getApplicationContext(), songLoader.getAllSong(getApplicationContext(), MediaStore.Audio.Media.IS_MUSIC + "=1" + " and " + MediaStore.Audio.Media.ARTIST_ID + "=" + Long.parseLong(singerID)));
